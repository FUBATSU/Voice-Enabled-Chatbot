...
var2 = ['I_was_created_by_Rishub_right_in_his_computer.',
        'Rishub', 'Some guy_whom i never got to know. But if its Rishub ur coincidentally Right!!']
...
colrep = [
    ...
    'Right now its plain as an Idli']
